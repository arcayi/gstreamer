...
int tutorial_main(int argc, char *argv[])
{
    ...
    g_object_set(data.source, "uri",
                 "file:///workspaces/Sports_AI/sportai.py/sintel_trailer-480p.webm",
                 NULL);
...
pad_added_handler(GstElement *src, GstPad *new_pad, CustomData *data)
{
    ...
    g_print("Received new pad '%s'(type '%s') from '%s':\n ", GST_PAD_NAME(new_pad), new_pad_type, GST_ELEMENT_NAME(src));
